...
public class GoogleAuthAdapter : IExternalAuthProvider
{
    private readonly GoogleSettings _settings;
    private readonly ILogger<GoogleAuthAdapter> _logger;
    ...
    public GoogleAuthAdapter(
        ...
        ILogger<GoogleAuthAdapter> logger,
    ...
    public async Task<ResultModel<PlayerExternalIdentityModel>> VerifyIdentityAsync(string code, string redirectUri)
    {
        string? idToken;
        try
        {
        ...
        try
        {
            ...
            return new PlayerExternalIdentityModel
            {
